...
<article id="origin">
  ...
  <figure class="mediumBackground right-small img-border rounded-corners"> <!---add more classes as needed-->
      <img class="rounded-corners" alt="Old books covers" src="images/originpic.jpg">
      <figcaption class="mediumBackground">Language may be the most important aspect of our lives</figcaption>
  </figure>
...
<article id="importance"> 
  ...
  <figure class="mediumBackground right-small img-border rounded-corners"> <!---add more classes as needed-->
    ...
    <figcaption class="mediumBackground">Translation between languages allows cultures to mix, which is necessary in the world we live in</figcaption>
  </figure>
